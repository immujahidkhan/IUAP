	...
	<div class="agileits_top_menu">
		<div class="w3l_header_left">
				<ul>
					...
					<li><i class="fa fa-user" aria-hidden="true"></i> <a href="admin/pages/login.php">Admin Login </a></li>
					<li><i class="fa fa-user" aria-hidden="true"></i> <a href="students/pages/login.php">Student Login </a></li>
					<li><i class="fa fa-search" aria-hidden="true"></i><a href="#" data-toggle="modal" data-target="#SearchModal">Search</a></li>						
				</ul>
			</div>
				...
				<div class="container">
					...
					<span class="icon-bar"></span>
						...
						<a class="navbar-brand" href="index.php">
							<h1><span class="fa fa-book" aria-hidden="true"></span> IUAP <label></label></h1>
						</a>
					</div>
					<!--/.navbar-header-->
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<nav class="link-effect-2" id="link-effect-2">
							<ul class="nav navbar-nav">
								...
								<li><a href="gallery.php" class="effect-3">Universities</a></li>
