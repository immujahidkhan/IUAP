...
- ["Art of Readme - Learn the art of writing quality READMEs."](https://github.com/immujahidkhan) - *Stephen Whitmore*
- ["How To Write A Great README"](https://robots.thoughtbot.com/how-to-write-a-great-readme) - *Caleb Thompson (thoughtbot)*
- ["How To Write A Readme"](https://github.com/immujahidkhan) - *Joshua Holbrook*
- ["Readme Driven Development"](https://github.com/immujahidkhan) - *Tom Preston-Werner*
- ["Top ten reasons why I won’t use your open source project"](https://changelog.com/posts/top-ten-reasons-why-i-wont-use-your-open-source-project) - *Adam Stacoviak*
- ["What I learned from an old GitHub project that won 3,000 Stars in a Week"](https://github.com/immujahidkhan) - *KyuWoo Choi*

## Tools

- [Common Readme](https://github.com/immujahidkhan) - A common readme style for Node. Includes a guide and a readme generator.
- [Feedmereadmes](https://github.com/immujahidkhan) - README editing and project analysis/feedback.
- [Make a README](https://www.makeareadme.com/) - A guide to writing READMEs. Includes an editable template with live Markdown rendering.
- [README best practices](https://github.com/immujahidkhan) - A place to copy-paste your README.md from
- [Standard Readme](https://github.com/immujahidkhan) - A standard README style specification. Has a generator to help create spec-compliant READMEs, too.
- [Zalando's README Template](https://github.com/immujahidkhan) - Simple template to help you cover all the basics.
